...
namespace xy3d.tstd.lib.screenTouch{

	public class ScreenTouch : MonoBehaviour {

		private static ScreenTouch _Instance;
		...
		public static ScreenTouch Instance{
			...
			get{
				...
				if(_Instance == null){
					...
					GameObject go = new GameObject("ScreenTouchGameObject");

					_Instance = go.AddComponent<ScreenTouch>();
				}
		...
		public static readonly string SCALE_CHANGE = "ScaleChange";
