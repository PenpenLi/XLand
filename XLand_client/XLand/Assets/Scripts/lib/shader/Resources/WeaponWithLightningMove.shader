...
struct v2f_surf {
  ...
  float4 custompack0 : TEXCOORD3; // isOutline lightningUV
...
v2f_surf vert_surf (appdata_full v) {
  ...
  o.custompack0.zw = customInputData.lightningUV;
...
fixed4 frag_surf (v2f_surf IN) : SV_Target {
  ...
  surfIN.lightningUV = IN.custompack0.zw;
...
struct v2f_surf {
  ...
  float4 custompack0 : TEXCOORD2; // isOutline lightningUV
